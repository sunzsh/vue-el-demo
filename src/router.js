...
var routes = [
  ...
  {path: '/ele-utile', component: ()=> import(/* webpackChunkName: "ele-utile" */ "@/views/ele-utile.vue")  },
  ...
  {path: '/route', component: ()=> import(/* webpackChunkName: "route" */ "@/views/route.vue")  },
  ...
  {path: '/table-tooltip', component: ()=> import(/* webpackChunkName: "table-tooltip" */ "@/views/table-tooltip.vue")  },
  ...
  {path: '/tmp', component: ()=> import(/* webpackChunkName: "tmp" */ "@/views/tmp.vue")  },
